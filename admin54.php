...
#          http://nixby.pro              #
##########################################
define( 'SITE_URL', "www.nixminsk.by" );
...
db_select_db( DB_NAME ) or die( db_error() );
    ...
    // if (SITE_URL=="www.nixminsk.by"){
    // define( 'CONF_DEFAULT_TEMPLATE', 'nano' );
    // }

settingDefineConstants();

## antaNTforce_compile
## if ( (int)CONF_SMARTY_FORCE_COMPILE) // or 1 or 1 // antaNT
if ( (int)CONF_SMARTY_FORCE_COMPILE OR 1) // or 1 or 1
{
    if ( file_exists( "core/cache/afcache.php" ) ) {
...
<html class="admin">
<head>
<meta http-equiv="content-type" content="text/html; charset=<?php echo DEFAULT_CHARSET_HTML; ?>">
...
<link href="lib/Bootstrap/bootstrap3.3.7_nixcolors/css/bootstrap.min.css" rel="stylesheet">
<link rel="stylesheet" href="data/admin/style.css" type="text/css">
<title<?php
...
echo ADMIN_CATALOG;
                ?></td>
                                               <td align="right" class="head7"><img src="data/admin/004.png" alt="" onclick="menuresetit('menu1')" id="menu12" style="cursor: pointer;"></td>
                                           </tr>
                                       </table>
                                   </td>
                               </tr>
...
echo ADMIN_SPECIAL_OFFERS;
                ?></a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=CSV_import"><?php
echo ADMIN_IMPORT_FROM_CSV;
                ?></a></td></tr></table>
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="<?php echo ADMIN_FILE; ?>?dpt=catalog&amp;sub=import_nixru_xml"><?php
echo ADMIN_IMPORT_FROM_NIXRU_XML;
                ?></a></td></tr></table>
...
echo ADMIN_CUSTOMERS_AND_ORDERS;
                ?></td>
                                               <td align="right" class="head7"><img src="data/admin/004.png" alt="" onclick="menuresetit('menu2')" id="menu22" style="cursor: pointer;"></td>
                                           </tr>
                                       </table>
                                   </td>
                               </tr>
...
echo ADMIN_SETTINGS;
                ?></td>
                                               <td align="right" class="head7"><img src="data/admin/004.png" alt="" onclick="menuresetit('menu3')" id="menu32" style="cursor: pointer;"></td>
                                           </tr>
                                       </table>
                                   </td>
                               </tr>
...
echo ADMIN_MODULES;
                ?></td>
                                               <td align="right" class="head7"><img src="data/admin/004.png" alt="" onclick="menuresetit('menu4')" id="menu42" style="cursor: pointer;"></td>
                                           </tr>
                                       </table>
                                   </td>
                               </tr>
...
echo ADMIN_STRING_MODULES_LINKEXCHANGE;
                ?></a></td></tr></table>
<!-- BEGIN filter-ajax -->
<table class="adn topj"><tr><td><img src="data/admin/drs.gif" alt=""></td><td width="100%"><a href="<?php echo ADMIN_FILE; ?>?dpt=modules&amp;sub=ajax-filter">
<?php echo "AJAX-фильтр"; ?>
</a></td></tr></table>
<!-- END filter-ajax -->
...
echo ADMIN_REPORTS;
                ?></td>
                                               <td align="right" class="head7"><img src="data/admin/004.png" alt="" onclick="menuresetit('menu5')" id="menu52" style="cursor: pointer;"></td>
                                               </tr>
                                           </table>
                                       </td>
                                   </tr>
...
echo ADMIN_LIST_ALL;
                ?></td>
                                               <td align="right" class="head7"><img src="data/admin/004.png" alt="" onclick="menuresetit('menu6')" id="menu62" style="cursor: pointer;"></td>
                                               </tr>
                                           </table>
                                       </td>
                                   </tr>
...
var editor1 = CKEDITOR.replace( 'myarea1', {
    customConfig: 'config_news.js'
} );
</script>
...
echo ADMIN_PRODUCT_NAME;
            ?>: <input type="text" name="name" value="<?php
echo $product["name"];
            ?>" style="width: 590px;" class="form-control imput-sm text-left"></td></tr>
<tr class="lins"><td align="left"><?php
echo ADMIN_PRODUCT_TITLE_PAGE;
            ?>: <input type="text" name="title" value="<?php
echo $product["title"];
            ?>" style="width: 590px;" class="form-control imput-sm text-left"><br><br><input type=checkbox name='free_shipping'
                <?php
...
echo ADMIN_EDIT_PROD_MN3;
            ?></td>
<td align="left" width="25%"><?php
echo ADMIN_EDIT_PROD_SHIPPING_FREIGHT;
            ?></td>
</tr>
<tr class="lins"><td align="left"><input type="text" name="price" value="<?php
echo $product["Price"];
            ?>" style="width: 100px;" class="form-control imput-sm text-right"></td>
...
// echo $product["in_stock"]; //antaNT64pro
                echo $product[6];
                ?>" style="width: 100px;" class="form-control imput-sm text-right">
<?php

                echo $product["in_stock_string"];
                ?>
</td>
<?php
} else {
...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="btn-toolbar">
            <div class="btn-group">
                <a class="btn btn-success btn-lg" target ="blank" href="#" onclick="upd(),document.getElementById('MainForm').submit(); return false"> Сохранить и в Админку</a>
                <a class="btn btn-default btn-lg" href="#" onclick="upd(),document.getElementById('MainForm').submit(),window.location = '<?php echo '/product_'.$_GET["productID"].'.html'?>'; return false"> Сохранить и в магазин</a>
            </div>
          ...
          if ( $codep == 1 ) {
                          $wer = $_GET["categoryID"];
                          echo "<a class='btn btn-danger btn-lg' href=\"" . ADMIN_FILE . "?categoryID=$wer&amp;stepback=1&amp;eaction=prod\">" .
                              CANCEL_BUTTON . "</a>";
                      } else {
                          $wer = $_GET["productID"];
                          echo "<a class='btn btn-warning btn-lg' href=\"" . ADMIN_FILE . "?productID=$wer&amp;stepback=1&amp;eaction=prod\">" .
                              CANCEL_BUTTON . "</a>";
                      }
          ?>
            </div>
            ...
            <div class="btn-group">
                ...
                <?php
                if ( $_GET["productID"] ) {
                                echo "<a class=\"btn btn-danger btn-lg\" href=\"#\" onClick=\"confirmDeletep('" .
                                    QUESTION_DELETE_CONFIRMATION . "','" . ADMIN_FILE . "?productID=" . $_GET["productID"] . "&amp;delete=1&amp;eaction=prod'); return false\">" .
                                    DELETE_BUTTON . "</a>";
                            }
...
if (  ( is_null( $value_row["option_value"] ) || $value_row["option_value"] == '' ) && $value_row["option_type"] ==
                    ...
                    } elseif ( $value_row["option_type"] == 0 ) {
                        echo ( "SetOptionValueTypeRadioButton( " . $option_row["optionID"] .
                            ", 'ANY_VALUE' );" );
                    } elseif ( $value_row["option_type"] == 1 ) {
...
<div class="btn-toolbar">
    <div class="btn-group">
        <a href="#" onclick="upd(),document.getElementById('MainForm').submit(); return false" class="btn btn-default btn-lg"><?php
echo SAVE_BUTTON;
            ?> 003</a>
        <a href="#" onclick="upd(),document.getElementById('MainForm').submit(); return false" class="btn btn-default btn-lg"><?php
echo SAVE_BUTTON;
...
var editor2 = CKEDITOR.replace( 'myarea2', {
    customConfig: 'config_news.js'
} );
</script>
...
break;
        default:
            ...
            #DEBUG
            # Если оно не нужно на все страницах, то вместо
            if ( ADMIN_SMARTY_DEBUG == "1" ) {
                $smarty->debugging = true;
            }

            # вставляем
            $smarty->debugging_ctrl="URL";
            #При таком раскладе консоль будет выводиться только тогда, когда в URL добавлена GET-переменная SMARTY_DEBUG.
            #Например,// http_://yousite.ru/?SMARTY_DEBUG или http_://yousite.ru/bla-bla/?xxx=yy&zzz=ddd&SMARTY_DEBUG
            #DEBUG

            ## antaNTforce_compile
            // if ( (int)CONF_SMARTY_FORCE_COMPILE ) {
            if ( (int)CONF_SMARTY_FORCE_COMPILE OR 1) {
...
//ant
            $errorsHtml = adminGetErrors();
            $smarty->assign( "errorsHtml", $errorsHtml );
