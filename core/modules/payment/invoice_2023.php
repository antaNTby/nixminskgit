<?php
/**
 * @connect_module_class_name CInvoice2023
 *
 */
...
class CInvoice2023 extends PaymentModule {
    public function initVars() {

        $this->title       = "Счёт и договор antaNT64 ©2023";
        $this->description = "Модуль формирования счетов на оплату для юридических лиц НОВОЕ";
        $this->sort_order  = 0;
    ...
    public function initSettingFields() {
        ...
        $this->SettingsFields["PM_INVOICE_STRING"] = array(
            "settings_value"         => LANG_NVOICE_STRING,
        ...
        $this->SettingsFields["PM_CONTRACT_STRING"] = array(
            "settings_value"         => LANG_CONTRACT_TITLE_DEFAULT,
        ...
        $this->SettingsFields["PM_PLACEHOLDER"] = array(
            "settings_value"         => LANG_EMPTY_PLACEHOLDER,
