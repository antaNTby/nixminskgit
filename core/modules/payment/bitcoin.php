<?php
/**
 * @connect_module_class_name CBitCoin
 *
 */
class CBitCoin extends PaymentModule {

    public $processing_url = 'https://api.cryptonator.com/api/merchant/v1/startpayment';
    ...
    public function after_processing_html( $orderID ) {
        ...
        while ( list( $k, $v ) = each( $post_1 ) ) {
            ...
            $hidden_fields_html .= '<input type="text" name="' . $k . '" value="' . $v . '" />' . "\n";
        }
