...
class JsHttpRequest {
    public $SCRIPT_ENCODING    = DEFAULT_CHARSET;
    ...
    public $prevDisplayErrors = null;
    // public $prevDisplayErrors = true;
     ...
     *
     * http://localhost/index.php?PHPSESSID=betv4di50oblpnuf5udrvosd191sde4r&do=cart&addproduct=20188412&xcart=yes&is_fake=yes&multyaddcount=1&JsHttpRequest=16674953566790-script
     *
    ...
    public function _obHandler( $text ) {
        ...
        // header( "Content-type: $ctype; charset=$encoding" ); //ant64
        $ctype = !empty( $this->_contentTypes[$this->LOADER] ) ? $this->_contentTypes[$this->LOADER] : "application/x-javascript";
