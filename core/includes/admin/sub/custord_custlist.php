...
{
    //unauthorized
    if ( CONF_BACKEND_SAFEMODE != 1 && ( !isset( $_SESSION["log"] ) || !in_array( 33, $relaccess ) ) ) {
        ...
        if ( isset( $_GET["deleteCustomerID"] ) ) {
            $_GET["deleteCustomerID"] = (int)$_GET["deleteCustomerID"];
        }

        if ( isset( $_POST["custgroupID"] ) ) {
            $_POST["custgroupID"] = (int)$_POST["custgroupID"];
        }
        ...
        if ( !isset( $_GET["customer_details"] ) ) {
            ...
            if ( !$c_login ) {
                ...
                if ( $_GET["customer_details"] == "order_history" ) {
                    ...
                    $smarty->assign( "navigator", $navigatorHtml );
                    $smarty->assign( "order_statuses", ostGetOrderStatuses() );
