...
WHERE (t1.enabled = 1)
  AND (t1.is_processed = 8)
  AND (t1.is_published = 8)
  AND (t1.vendorID = {$vendorID})
...
if ( !is_array( $data ) || !count( $data ) ) {
    ...
    $convertedProducts = prdConvertFromPriceToCatalog( $data, $data_permanent_categoryID, "process_AssocLink" );
