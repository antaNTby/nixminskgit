...
$.extend( RowGroup.prototype, {
    ...
    _rowWrap: function ( display, className, level )
    {
        ...
        if ( typeof display === 'object' && display && display.nodeName && display.nodeName.toLowerCase() === 'tr') {
            row = $(display);
        }
        // else if (display instanceof $ && display.length && display[0].nodeName.toLowerCase() === 'tr') {
        else if (display instanceof $ && display && display.length && display[0].nodeName.toLowerCase() === 'tr') {
            row = display;
        }
        else {
            row = $('<tr/>')
